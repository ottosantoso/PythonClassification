<!-- Main content -->
    <section class="content">
      ...
      <!-- Nama Guru -->
             ...
             <form action="<?php echo base_url();?>index.php/c_guru/view_siswa" method="post">
       ...
       <div class="box-body">
          ...
          <?php $i=0; if(!empty($list_data)){;foreach($list_data as $row) { ?>
            <tr>
              ...
              <th><input type="text" class="form-control" name="tugas<?php echo $i;?>" placeholder="tugas" value="<?php echo $row->tugas;?>" readonly></th>
            <th><input type="text" class="form-control" name="harian<?php echo $i;?>" placeholder="harian" value="<?php echo $row->harian;?>" readonly></th>
            <th><input type="text" class="form-control" name="uts<?php echo $i;?>" placeholder="uts" value="<?php echo $row->uts;?>" readonly></th>
            <th><input type="text" class="form-control" name="uas<?php echo $i;?>" placeholder="uas" value="<?php echo $row->uas;?>" readonly></th>
            <th><input type="text" class="form-control" name="keterampilan<?php echo $i;?>" placeholder="praktek" value="<?php echo $row->keterampilan;?>" readonly></th>
            <th><input type="text" class="form-control" name="sikap<?php echo $i;?>" placeholder="sikap" value="<?php echo $row->sikap;?>" readonly></th>            
            </tr>
