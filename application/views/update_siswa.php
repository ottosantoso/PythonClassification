        <form action="<?php echo base_url();?>index.php/c_siswa/update_siswa" method="post">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nip" name="nis" value=<?php echo $row->nis;?> readonly>
                </div>
              <div class="form-group">
                  <label for="exampleInputName">Nama Siswa</label>
                  <textarea class="form-control" id="namasiswa" name="namasiswa"> <?php echo $row->namasiswa ?> </textarea>
                </div>
              <div class="form-group">
                <label>Jenis Kelamin</label>
                <select class="form-control select2" name="jeniskelamin" style="width: 100%;">
                  <option selected="selected" ><?php echo $row->jeniskelamin ?> </option>
