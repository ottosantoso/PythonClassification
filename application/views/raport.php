...
<button class="btn btn-warning waves-effect waves-light m-b-5"> 
    ...
    <span><a href="<?php echo base_url(); ?>index.php/c_cetak/raport?kelas=<?php echo $_GET['kelas'];?>&guru=<?php echo $_GET['guru'];?>&nama=<?php echo $_GET['nama'];?>
              &nis=<?php echo $_GET['nis'];?>&semester=<?php echo $_GET['semester']; ?>&thnajar=<?php echo $_GET['thnajar']; ?>&idkelas=<?php echo $_GET['idkelas']; ?>">Cetak </a></span> 
...
<table width="1012" height="167" border="1" style="border-color:#3CF">
  ...
  <tr>
    <td height="32" align="center">Nilai</td>
    <td align="center">Predikat</td>
    <td align="center">Nilai</td>
    <td align="center">Predikat</td>
    <td align="center">Dalam Mapel</td>
    <td align="center" width="200">Antar Mapel</td>
  </tr>
  <?php 
  $tes=0;
  $totMapel=0;
  ...
  <tr>
    ...
    <td align="center"> <?php	if($row->sikap>=80 and $row->sikap<=100){
        ...
        <?php 
            ...
            {
                echo " <td align='center' rowspan='".$totMapel."'>".$nilaisikap='Sudah menunjukkan sikap menghargai dalam menerapkan sikap jujur, disiplin, tanggung jawab, toleransi, gotong royong, santun, dan percaya diri'."</td>";
                $tes++;
            }elseif (($totDes < 20 ) and $tes==0) {
                echo " <td align='center' rowspan='".$totMapel."'>".$nilaisikap='Sudah menunjukkan sikap menghayati dalam menerapkan sikap jujur, disiplin, tanggung jawab, toleransi, gotong royong, santun, dan percaya diri'."</td>";
                $tes++;
            }elseif (($totDes < 30 ) and $tes==0) {
                echo " <td align='center' rowspan='".$totMapel."'>".$nilaisikap='Sudah menunjukkan sikap konsisten dalam menerapkan sikap jujur, disiplin, tanggung jawab, toleransi, gotong royong, santun, dan percaya diri'."</td>";
                $tes++;
            }
