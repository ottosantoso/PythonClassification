 ...
 <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#">Upload File Nilai <i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                    <li class="treeview"><a href="<?php echo base_url()?>index.php/c_guru/form_upload"><i class="fa fa-circle-o"></i> Upload Nilai</a>
                    <li class="treeview"><a href="<?php echo base_url()?>index.php/c_guru/form_upload"><i class="fa fa-circle-o"></i> Upload Deskripsi</a>
                </ul>
            </li>
          </ul>
        </li>
