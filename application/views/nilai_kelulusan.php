   ...
   <!-- Main content -->
    ...
    <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <form action="<?php echo base_url();?>index.php/c_wali/view_mapel" method="post">
              <div class="form-group">
               ...
               <button type="view" name="view"  value="1" class="btn btn-primary">View</button>
            </form>
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <?php 
                    ...
                    if($Pengetahuan < $row->kkm){
                      echo $Pengetahuan.' - Belum Lulus - ';
                    }else{
                      echo "Nilai Sudah Lulus";
                    }
                     ?></th>                    
                  <th>
                  <?php if($row->sikap < $row->kkm){
                    echo $row->sikap.' - Belum Lulus - ';
                  }else{
                    echo "Nilai Sudah Lulus";
                  }
                  ...
                  <th>
                  <?php 
                    if($row->keterampilan < $row->kkm ){
                      echo $row->keterampilan.' - Belum Lulus - ';
                    } else {
                        echo "Nilai Sudah Lulus";
                    }
                    ?>
