         ...
         <!-- User Account: style can be found in dropdown.less -->
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url();?>assets/dist/img/otto.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $this->session->userdata('username');?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url();?>assets/dist/img/otto.jpg" class="img-circle" alt="User Image">
 ...
 <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <?php } ?>
             <li><a href="cetakkelas.php"><i class="fa fa-circle-o"></i> Cetak Data Kelas Siswa</a></li>
          </ul>
        </li>
        <?php }?>
        <!--Data NIlai -->
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url()?>index.php/c_admin/lihat_nilai"><i class="fa fa-circle-o"></i> View Nilai</a></li>
          </ul>
        </li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url()?>index.php/c_cetak/siswa"><i class="fa fa-circle-o"></i>File Kelas Siswa</a></li>
